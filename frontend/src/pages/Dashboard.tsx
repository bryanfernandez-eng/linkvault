...
import { Plus, Pin, Star, ExternalLink, Copy, Edit3, Sparkles } from "lucide-react"
import { getDashboard, logout, reorderSections, updateLink } from "../services/api"
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Empty State */}
        {dashboardData.sections.length === 0 && dashboardData.pinned_links.length === 0 && (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-slate-100 mb-3">Welcome to LinkVault!</h3>
            <p className="text-slate-400 text-lg mb-8 max-w-md mx-auto">
              Start organizing your links by creating your first link or section.
            </p>
      ...
      {/* Modals */}
      {isLinkModalOpen && (
        <LinkModal link={editingLink} sections={dashboardData.sections} onClose={handleCloseModals} />
      )}

      {isSectionModalOpen && <SectionModal section={editingSection} onClose={handleCloseModals} />}
    </div>
  )
}
